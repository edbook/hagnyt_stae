...
# -*- coding: utf-8 -*-
#
# Hagnýt stærðfræðigreining documentation build configuration file, created by
...
latex_documents = [
  ('index', 'StaeI.tex', u'Hagnýt stærðfræðigreining (STÆ105G)',
   u'Valentina Giangreco M Puletti', 'manual'),
]
...
man_pages = [
    ('index', 'strfrigreiningi', 'Hagnýt stærðfræðigreining Documentation',
...
texinfo_documents = [
  ('index', 'StrfrigreiningI', 'Hagnýt stærðfræðigreining Documentation',
   'Benedikt Steinar Magnússon', 'StrfrigreiningI', 'One line description of project.',
   'Miscellaneous'),
]
...
#epub_title = 'Hagnýt stærðfræðigreining'
